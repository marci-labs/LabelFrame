...
| 73 | 界面文案用户化——开发者向文案修正（模式名 / 路径 / 扩展名 / 内部机制术语用户化或删除，决策 #137）与连接配置低频收纳（设置页「连接方式」默认折叠为摘要一行） | ✅ 已完成（2026-09-17 本地 lint / 304 项前端测试 / 双构建全绿，行为零变化；用户视角界面走查转待验收，[#108](https://github.com/marci-labs/LabelFrame/issues/108)） |
